    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('types.name')->label('Tipos de formulario')->searchable(),
                Tables\Columns\TextColumn::make('categories.name')->label('Categorías')->searchable(),
