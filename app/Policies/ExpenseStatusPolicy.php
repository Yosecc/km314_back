...
class ExpenseStatusPolicy
{
    ...
    {
        return $user->can('view_any_expense::status');
    }
    ...
    {
        return $user->can('create_expense::status');
    }
    ...
    {
        return $user->can('delete_any_expense::status');
    }
    ...
    {
        return $user->can('force_delete_any_expense::status');
    }
    ...
    {
        return $user->can('restore_any_expense::status');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, ExpenseStatus $expenseStatus): bool
    {
        return $user->can('replicate_expense::status');
    }
    ...
    {
        return $user->can('reorder_expense::status');
    }
}
