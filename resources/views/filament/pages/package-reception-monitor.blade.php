<x-filament-panels::page>
    <div class="package-monitor" wire:poll.30s x-data="{ tutorialOpen: @entangle('showTutorial').live, tutorialStep: 1, closeTutorial() { this.tutorialOpen = false; this.tutorialStep = 1; this.$wire.markTutorialSeen(); } }">
        ...
        <div class="pm-hero">
            ...
            <div class="pm-hero-actions">
                <button type="button" class="pm-help" @click="tutorialStep = 1; tutorialOpen = true"><x-heroicon-o-question-mark-circle class="h-5 w-5" /> Cómo funciona</button>
        ...
        <div x-cloak x-show="tutorialOpen" x-transition.opacity class="pm-tutorial-backdrop" role="dialog" aria-modal="true" aria-labelledby="pm-tutorial-title" @click="closeTutorial()" @keydown.escape.window="if (tutorialOpen) closeTutorial()">
            <section class="pm-tutorial" @click.stop>
                ...
                <div class="pm-tutorial-progress" aria-label="Progreso del tutorial">
                    <template x-for="number in 3" :key="number"><button type="button" :class="{ active: tutorialStep === number, complete: tutorialStep > number }" @click="tutorialStep = number"><span x-text="number"></span></button></template>
                </div>

                <div x-show="tutorialStep === 1" x-transition.opacity class="pm-tutorial-step">
                ...
                <div x-show="tutorialStep === 2" x-transition.opacity class="pm-tutorial-step">
                ...
                <div x-show="tutorialStep === 3" x-transition.opacity class="pm-tutorial-step">
                ...
                <footer class="pm-tutorial-footer">
                    ...
                    <div>
                        <button type="button" class="pm-tutorial-prev" x-show="tutorialStep > 1" @click="tutorialStep--"><x-heroicon-o-arrow-left /> Anterior</button>
                        <button type="button" class="pm-tutorial-next" x-show="tutorialStep < 3" @click="tutorialStep++">Siguiente <x-heroicon-o-arrow-right /></button>
                        @if($data['can_create'])
