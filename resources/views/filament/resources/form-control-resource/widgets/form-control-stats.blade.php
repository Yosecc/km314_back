<x-filament-widgets::widget>
    <section class="fcw" wire:poll.30s>
        <header class="fcw-head">
            <div><span></span><div><h3>Formularios de Control</h3><p>Resumen actualizado en tiempo real</p></div></div>
